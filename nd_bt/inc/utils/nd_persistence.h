...
#ifndef INC_ND_SECURITY_PERSISTENCE_H_
#define INC_ND_SECURITY_PERSISTENCE_H_
...
class PersistenceDB {
 public:
    ...
    // integrity status, delete status
    bool IntegrityCheck(bool delete_on_failure = false);
    bool Open();
...
#endif  // INC_ND_SECURITY_PERSISTENCE_H_
