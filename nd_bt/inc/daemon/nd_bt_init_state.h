...
#ifndef INC_ND_BT_INIT_STATE_H_
#define INC_ND_BT_INIT_STATE_H_
...
class InitState : public interface::IState {
 public:
    explicit InitState(nd::device::BTManager *bt_man);
 ...
 private:
    nd::device::BTManager *bt_man_ = nullptr;
};

} // namespace device
} // namespace nd

#endif  // INC_ND_BT_INIT_STATE_H_
