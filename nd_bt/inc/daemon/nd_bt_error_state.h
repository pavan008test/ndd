...
#ifndef INC_ND_BT_ERROR_STATE_H_
#define INC_ND_BT_ERROR_STATE_H_
...
class ErrorState : public interface::IState {
 public:
    explicit ErrorState(BTManager *bt_man_ptr);
...
#endif  // INC_ND_BT_ERROR_STATE_H_
