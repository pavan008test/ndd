...
then
	...
	if [[ $(md5sum /boot/backup/tegra210-jetson-cv-camera-li-mipi-adpt-a01-devkit.dtb | awk -F " " '{print $1}') == e165f983b3e1f5d5203aaf474705ea78 && $(md5sum /boot/backup/tegra210-jetson-tx1-p2597-2180-a01-devkit.dtb | awk -F " " '{print $1}') == 6cb3e5706958725bb2ea87f2d7ca362e ]]; then
		...
		if [[ $(md5sum /boot/tegra210-jetson-tx1-p2597-2180-a01-devkit.dtb | awk -F " " '{print $1}') == 6cb3e5706958725bb2ea87f2d7ca362e && $(md5sum /boot/tegra210-jetson-cv-camera-li-mipi-adpt-a01-devkit.dtb | awk -F " " '{print $1}') == e165f983b3e1f5d5203aaf474705ea78 ]]
			then
