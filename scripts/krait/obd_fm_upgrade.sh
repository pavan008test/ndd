...
function check_if_flash_binary()
{
    ...
    Exce="/home/ubuntu/.nddevice/$otaPath/run_as_root/obd_fw_update/fw_update_mcs"
...
# Restart OBD Service  #
#############################
function obd_service_restart() {
        echo "=== obd service restart ===\n"
        echo "Restarting service"

        sudo nd_service.sh -c restart -n obd
...
obd_config="/data/nd_files/config/obd_info.txt"
