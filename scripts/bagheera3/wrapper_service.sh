...
# Arg-1. service name
# Arg-2. to wait for ntdi_bag3 to complete or 30 secs which ever is earlier This is also default option if nothing is specified
# If you wish not to wait for ntdi_bag3 service you can give 'dontwait' option
