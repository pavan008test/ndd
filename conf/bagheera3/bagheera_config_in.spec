{
    ...
    "camera": {
        ...
        "side_cam_disable_threshold_time": {
            "type": "int",
            "value": 7200000,
            "desc": "in milliseconds if a side camera crashes for max_cam_crash_count number",
            "rules": {
            "min": 0,
            "max": 86400000
            }
        ...
        "outward_nrt_ld_width": {
            "type": "int",
            "value": 854,
            "desc": "width for outward camera nrt low definition pipeline",
            "rules": {
            "allowed_values": [
                640,
                854,
        ...
        "outward_nrt_ld_height": {
            "type": "int",
            "value": 480,
            "desc": "height for outward camera nrt low definition pipeline",
            "rules": {
            "allowed_values": [
                360,
                480,
        ...
        "outward_nrt_ld_bitrate": {
            "type": "int",
            "value": 1000000,
            "desc": "bitrate for outward camera nrt low definition pipeline",
            "rules": {
            "min": 200000,
            "max": 24000000
            }
        ...
        "inward_nrt_ld_width": {
            "type": "int",
            "value": 854,
            "desc": "width for inward camera nrt low definition pipeline",
            "rules": {
            "allowed_values": [
            640,
            854,
        ...
        "inward_nrt_ld_height": {
            "type": "int",
            "value": 480,
            "desc": "height for inward camera nrt low definition pipeline",
            "rules": {
            "allowed_values": [
            360,
            480,
        ...
        "inward_nrt_ld_bitrate": {
            "type": "int",
            "value": 500000,
            "desc": "bitrate for inward camera nrt low definition pipeline",
            "rules": {
            "min": 200000,
            "max": 24000000
            }
        ...
        "leftcam_nrt_width": {
            "type": "int",
            "value": 1280,
            "desc": "width for left camera nrt pipeline",
            "rules": {
                "allowed_values": [
                    1280,
                    1920,
        ...
        "leftcam_nrt_height": {
            "type": "int",
            "value": 720,
            "desc": "height for left camera nrt pipeline",
            "rules": {
                "allowed_values": [
                    720,
                    1080,
        ...
        "leftcam_nrt_fps": {
            "type": "int",
            "value": 15,
            "desc": "fps for left camera nrt pipeline",
            "rules": {
                "min": 15,
                "max": 60
            }
        ...
        "leftcam_nrt_crop": {
            "type": "string",
            "value": "false",
            "desc": "decides where to crop left cam nrt video (Not using)",
            "rules": {
                "allowed_values": [
                    "false"
                ]
        ...
        "rightcam_nrt_width": {
            "type": "int",
            "value": 1280,
            "desc": "width for right camera nrt pipeline",
            "rules": {
                "allowed_values": [
                    1280,
                    1920,
        ...
        "rightcam_nrt_height": {
            "type": "int",
            "value": 720,
            "desc": "height for right camera nrt pipeline",
            "rules": {
                "allowed_values": [
                    720,
                    1080,
        ...
        "rightcam_nrt_fps": {
            "type": "int",
            "value": 15,
            "desc": "fps for right camera nrt pipeline",
            "rules": {
                "min": 15,
                "max": 60
            }
        ...
        "rightcam_nrt_crop": {
            "type": "string",
            "value": "false",
            "desc": "decides where to crop right cam nrt video (Not using)",
            "rules": {
                "allowed_values": [
                    "false"
                ]
        ...
        "dms_nrt_width": {
            "type": "int",
            "value": 1296,
            "desc": "width for dms nrt pipeline",
            "rules": {
                "allowed_values": [
                    1296,
                    1600
        ...
        "dms_nrt_height": {
            "type": "int",
            "value": 1296,
            "desc": "height for dms nrt pipeline",
            "rules": {
                "allowed_values": [
                    1296,
                    1300,
        ...
        "dms_nrt_bitrate": {
            "type": "int",
            "value": 8000000,
            "desc": "bitrate for dms nrt pipeline ",
            "rules": {
                "min": 200000,
                "max": 24000000
            }
        ...
        "dms_ld_enabled": {
            "type": "bool",
            "value": true,
            "desc": "dms low definition enabled",
            "rules": {
            "allowed_values": [
                true,
                false
        ...
        "dms_nrt_ld_width": {
            "type": "int",
            "value": 720,
            "desc": "width for dms camera nrt low definition pipeline",
            "rules": {
            "allowed_values": [
            720,
            1296,
        ...
        "dms_nrt_ld_height": {
            "type": "int",
            "value": 720,
            "desc": "height for dms camera nrt low definition pipeline",
            "rules": {
            "allowed_values": [
            720,
            1296,
        ...
        "dms_nrt_ld_bitrate": {
            "type": "int",
            "value": 1000000,
            "desc": "bitrate for dms camera nrt low definition pipeline",
            "rules": {
            "min": 200000,
            "max": 24000000
            }
    ...
    "dms_camera": {
        "enabled": {
            "type": "string",
            "value": "false",
            "desc": "flag for enabling dms camera",
            "rules": {
                "allowed_values": [
                    "true",
                    "false"
    ...
    "imu": {
        ...
        "lpf_fir_order": {
            "type": "int",
            "value": 26,
            "desc": "number of samples the low-pass FIR filter uses to smooth the signal.",
            "rules": {
                "allowed_values": [
                    0,
                    26,
    ...
    "INSTALLER_APP": {
        ...
        "dms_camera_flip": {
            "type": "int",
            "value": 0,
            "desc": "for opposite mounting of dms camera, make this flag to 1",
            "rules": {
                "allowed_values": [
                    0,
                    1
        ...
        "dms_skip_analytics": {
            "type": "bool",
            "value": false,
            "desc": "for testing without analytics processing, make this flag to true",
            "rules": {
                "allowed_values": [
                    true,
                    false
    ...
    "Transcode": {
        ...
        "store_lq_dms_file":{
            "type": "bool",
            "value": false,
            "desc": "false: delete LQ DMS file after 5 session. true: delete LQ DMS file after num_hq_videos_max(=120) session. Keep alert file same as outward alert file.",
            "rules": {
                "allowed_values": [
                    true,
                    false
        ...
        "num_dms_videos_max":{
            "type": "int",
            "value": 120,
            "desc": "max number of dms videos to keep in storage.",
            "rules": {
                "min": 1,
                "max": 6000
            }
        ...
        "enable_side_cam_transcode": {
            "type": "bool",
            "value": false,
            "desc": "if enabled, transcodes left/right camera videos. if enable = false, this value is ignored",
            "rules": {
                "allowed_values": [
                    true,
                    false
    ...
    "NightMode": {
        ...
        "led_level": {
            "type": "int",
            "value": 3,
            "desc": "brightness level for LEDs. Accepted levels: 1 to 15 only. 0-> Auto Mode: Brightness Control based on Photodiode",
            "rules": {
            "min": 0,
            "max": 15
            }
