...
#exit 101 ---> Binary 1 /usr/bin/fwdwl-litearm64le does not exist
...
FILE1=/usr/bin/fwdwl-litearm64le
TIMEOUT=240
...
echo "IMAGE UPGRADE FROM SIERRA FIRMWARE - LITE VERSION"
...
(fwdwl-litearm64le -d /dev/ttyUSB0 -p /dev/qcqmi0 -m 2 -f $1 ) & pid=$!
