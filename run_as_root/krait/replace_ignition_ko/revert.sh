...
if [[ -f /home/ubuntu/.nddevice/backup/gpio-ignition.ko  ]]; then
    ...
    sudo cp -f /home/ubuntu/.nddevice/backup/gpio-ignition.ko /usr/lib/modules/4.9.160-perf/kernel/drivers/gpio/
    if [[ $? != 0 ]]; then exit 1; fi
    sync /usr/lib/modules/4.9.160-perf/kernel/drivers/gpio/gpio-ignition.ko
