...
md5sum_GobiNet_system=$(md5sum /lib/modules/4.9.160-perf/kernel/drivers/net/usb/GobiNet/GobiNet.ko  |awk '{print $1}')
md5sum_GobiSerial_system=$(md5sum /lib/modules/4.9.160-perf/kernel/drivers/usb/serial/GobiSerial/GobiSerial.ko |awk '{print $1}')
...
status=$(copy_file -c move -f GobiNet.ko -d /lib/modules/4.9.160-perf/kernel/drivers/net/usb/GobiNet/ -b /home/ubuntu/.nddevice/backup -m $md5sum_GobiNet  -p 644 -o root:root)$?
...
log "Checksum not matching copying the ko file"
status=$(copy_file -c move -f GobiSerial.ko -d /lib/modules/4.9.160-perf/kernel/drivers/usb/serial/GobiSerial/ -b /home/ubuntu/.nddevice/backup -m $md5sum_GobiSerial  -p 644 -o root:root)$?
