...
if [[ -f /home/ubuntu/.nddevice/backup/gpio-ignition.ko  ]]; then
    ...
    sudo cp -f /home/ubuntu/.nddevice/backup/gpio-ignition.ko  /lib/modules/4.9.299-tegra/kernel/drivers/bag2_vendor/ignition/
    if [[ $? != 0 ]]; then exit 1; fi
    sync  /lib/modules/4.9.299-tegra/kernel/drivers/bag2_vendor/ignition/gpio-ignition.ko
