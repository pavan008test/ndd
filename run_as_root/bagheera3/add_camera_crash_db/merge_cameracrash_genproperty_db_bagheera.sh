...
CRASH_DB="/home/ubuntu/.nddevice/camera_crash.db"
...
TABLE_EXISTS=$(/bin/vendor/sqlite3 "$CRASH_DB" "SELECT name FROM sqlite_master WHERE type='table' AND name='CAMERA_CRASH_DB';")
...
/bin/vendor/sqlite3 "$GENPROP_DB" << EndOfCommands
