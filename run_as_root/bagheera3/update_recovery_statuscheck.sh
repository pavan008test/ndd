...
timeout 300 sh -c 'while : ; do if [ -n "`grep "update_recovery" /home/ubuntu/.nddevice/ota_temp/run_as_root/update_recovery_status`" ] ; then break; else sleep 2; continue; fi ; done' && echo "update_recovery success"
...
sudo /usr/bin/nd_service.sh -c clean -n update_recovery -p /home/ubuntu/.nddevice/__version__/service/
