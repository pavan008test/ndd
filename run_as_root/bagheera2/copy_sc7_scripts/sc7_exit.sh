...
#OBD
gpio_test -n 303 -i #MC_JTX1_STATUS
gpio_test -n 255 -o 1 #RESET
#FOR OUTCAM
gpio_test -n 456 -i #CAM0_PWR
gpio_test -n 461 -o 0 #CAM0_RST
sleep 0.02
gpio_test -n 461 -i #CAM0_RST
...
mount -a
touch /media/data/hello.txt
rm /media/data/hello.txt
sync
...
#For INCAM
gpio_test -n 393 -o 1 #Power
sleep 0.02
gpio_test -n 426 -o 0 #PWDN
sleep 0.02
gpio_test -n 277 -o 1 #Reset
