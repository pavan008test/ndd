...
#define BIT_SELF_TEST_CHECK 0x01
#define SELF_TEST_CHECK 1
#define ENABLE_FLAG 1
#define DISABLE_FLAG 0
#define IMU_GPIO 298
#define TEMP_BUF_SIZE 100
#define SENSOR_ARRAY_SIZE 3
#define RAW_DATA_FILE_SIZE 1000
#define SYSFS_NAME_SIZE 500
...
unsigned long long wallclock_time;
};

extern struct imu_data imu_global_data;
extern int imu_fd;
extern struct imu_config imu_config_data;
extern int poll_mode, sync_mode, wom_mode,data_ready_enable;
